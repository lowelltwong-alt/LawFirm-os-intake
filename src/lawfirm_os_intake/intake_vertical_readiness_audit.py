...
REQUIRED_SLICES: tuple[SliceDefinition, ...] = (
    ...
    SliceDefinition(
        slice_id=14,
        title="Budget human review packet",
        requirement_summary=(
            "Budget proposal, human revision, actual variance, carrier rejection, appeal, "
            "Lake-handoff, and learning-loop pressure can be consolidated into one "
            "human-review packet with recommendations, why-notes, red-team notes, "
            "decision templates, and no-action boundaries."
        ),
        proof_artifact_refs=(
            "src/lawfirm_os_intake/budget_human_review_packet.py",
            "schemas/budget-human-review-packet.schema.json",
            "schemas/budget-human-review-recommendation.schema.json",
            "tests/test_budget_human_review_packet.py",
            "docs/decisions/TRACE-2026-06-27-budget-human-review-packet.md",
        ),
        command_refs=("build-budget-human-review-packet",),
        target_owner_repos=(
            "LawFirm-os-intake",
            "LawFirm-os-orchestrator",
            "LawFirm-os-exceptions-lake-runtime",
        ...
        remaining_external_actions=(
            "Humans must still make append-only budget/rejection/appeal decisions.",
            "Orchestrator must still own any runtime human pause or external action.",
            "Exception Lake must still own append-only admission.",
        ),
    ),
    SliceDefinition(
        slice_id=15,
    ...
    SliceDefinition(
        slice_id=17,
        title="Budget actual variance owner adoption packets",
        requirement_summary=(
            "Actual-cost variance ledger evidence can be routed to Semantic "
            "Substrate, Orchestrator, and Exception Lake owner-review packets "
            "without billing reads/writes, sibling writes, Lake/SQLite admission, "
            "budget mutation, or learning."
        ),
        proof_artifact_refs=(
            "src/lawfirm_os_intake/budget_actual_variance_owner_adoption.py",
            "schemas/budget-actual-variance-owner-adoption-report.schema.json",
            "schemas/budget-actual-variance-owner-adoption-packet.schema.json",
            "tests/test_budget_actual_variance_owner_adoption.py",
            "docs/decisions/TRACE-2026-06-29-budget-actual-variance-owner-adoption.md",
        ),
        command_refs=("build-budget-actual-variance-owner-adoption",),
        target_owner_repos=(
            "LawFirm-os-semantic-substrate",
            "LawFirm-os-orchestrator",
            "LawFirm-os-exceptions-lake-runtime",
        ...
        remaining_external_actions=(
            "Orchestrator must own any production billing actuals read boundary.",
            "Exception Lake must own append-only actual-variance admission and SQLite migrations.",
            "Humans must still review any variance, source-followup, or learning disposition.",
        ),
    ),
    SliceDefinition(
        slice_id=18,
    ...
    SliceDefinition(
        ...
        requirement_summary=(
            ...
            "fixture-generation PR instructions without creating fixtures, ingesting "
            "public records, authorizing adapters, or writing Lake/SQLite records."
        ),
        proof_artifact_refs=(
            "src/lawfirm_os_intake/public_synthetic_fixture_pr_package.py",
            "schemas/public-synthetic-fixture-pr-package-report.schema.json",
            "schemas/public-synthetic-fixture-pr-package-item.schema.json",
            "tests/test_public_synthetic_fixture_pr_package.py",
            "docs/decisions/TRACE-2026-06-26-public-synthetic-fixture-pr-package.md",
            "docs/public-data-test-plan.md",
        ),
        command_refs=("build-public-synthetic-fixture-pr-package",),
        target_owner_repos=(
            "LawFirm-os-intake",
            "LawFirm-os-legal-knowledge-runtime",
        ),
        remaining_external_actions=(
            "Humans must create and review any fixture-generation PR manually.",
            "Fixture PR review must prove no public payload or identity contamination.",
            "Legal Knowledge Runtime must own any future lookup or retrieval adapter.",
        ),
    ),
    SliceDefinition(

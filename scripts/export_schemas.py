...
MODELS = {
    ...
    "evaluation-condition-spec.schema.json": EvaluationConditionSpec,
    "condition-run-record.schema.json": ConditionRunRecord,
    ...
    "canonical-priced-work-plan.schema.json": CanonicalPricedWorkPlan,
    "stratified-synthetic-matter.schema.json": StratifiedSyntheticMatter,
    "stratified-corpus-manifest.schema.json": StratifiedCorpusManifest,
    "priced-phase-row.schema.json": PricedPhaseRow,
    "priced-role-cell.schema.json": PricedRoleCell,
    "applied-driver-effect.schema.json": AppliedDriverEffect,

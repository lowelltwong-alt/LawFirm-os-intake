...
| `legal_budget_review_form.md` | Intake candidate surface | Intake -> Human pricing/review authority / Orchestrator review path | Standalone budget review surface showing calculation summary, itemized standard-scenario budget lines, scenario-set comparison, evidence-bound supports, review checks, and non-submission boundary |

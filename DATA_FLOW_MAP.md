...
| `ReviewPackageManifest` and `matter_opening_review_package.md` | Intake candidate surface | Intake -> Human reviewer / Orchestrator review path | One-run review surface linking contract state, knowns, candidate alternatives, unknowns, required human gates, visible evidence refs, conflict seed, budget calculation and lines, exception candidates, blockers, ledgers, and prohibited actions |

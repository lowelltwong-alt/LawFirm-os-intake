...
| `BudgetPreconditionReport` | Intake candidate surface | Intake -> Human reviewer / Orchestrator review path | Deterministic proof that the budget stage had a matching confirmed human confirmation before emitting conflict seed, proposal, readiness, safety, or review package artifacts |

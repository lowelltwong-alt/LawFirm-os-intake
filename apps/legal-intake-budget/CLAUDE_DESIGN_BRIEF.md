...
- Synthetic QA blocker drilldown from `src/fixtures/demo-synthetic-qa-blocker-report.json`, showing pending, blocked, and failed review rows without deriving a new authority surface in the UI.
